...
class SubCategoriesTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                SpatieMediaLibraryImageColumn::make('image')->collection('image')->label(__('Image'))->circular(),
                TextColumn::make('name.ar')->label(__('Name (AR)'))->searchable()->sortable(),
                TextColumn::make('name.en')->label(__('Name (EN)'))->searchable()->toggleable(),
