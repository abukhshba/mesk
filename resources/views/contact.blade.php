...
<div class="page-header py-24 rounded-b-[3rem] shadow-sm mb-12">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 class="text-4xl sm:text-5xl font-black text-primary-950 leading-tight">{{ __('messages.contact_title') }}</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-4 p-5 bg-neutral-50 rounded-2xl border border-neutral-100 hover:border-neutral-200 transition-colors">
                    <div class="w-10 h-10 bg-neutral-900 rounded-xl flex items-center justify-center shrink-0">
                ...
                <div class="flex items-start gap-4 p-5 bg-neutral-50 rounded-2xl border border-neutral-100">
                    <div class="w-10 h-10 bg-neutral-900 rounded-xl flex items-center justify-center shrink-0 mt-0.5">
                ...
                <a href="https://wa.me/{{ $settings->whatsapp }}" target="_blank"
                   class="flex items-center gap-4 p-5 bg-neutral-950 rounded-2xl hover:bg-neutral-900 transition-colors">
