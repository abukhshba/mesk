    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div class="flex items-end justify-between mb-12">
            <div>
                ...
                <h2 class="text-2xl sm:text-4xl font-black text-neutral-900">{{ __('app.featured_categories') }}</h2>
            </div>
            @php
...
<section class="py-10 sm:py-20 bg-neutral-50 border-t border-neutral-100">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div class="flex items-end justify-between mb-12">
            <div>
                <div class="accent-line mb-4"></div>
                <h2 class="text-4xl font-black text-neutral-900">{{ __('app.featured_products') }}</h2>
            </div>
            <a href="{{ route('products.index') }}"
               class="hidden sm:inline-flex items-center gap-1.5 text-sm font-bold text-neutral-500 hover:text-neutral-900 transition-colors">
                {{ app()->getLocale() === 'ar' ? 'عرض الكل' : 'View all' }}
...
<section class="pt-16 bg-white border-t border-neutral-100">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
                <h3 class="text-2xl font-black text-neutral-900">{{ __('app.whatsapp_cta_title') }}</h3>
                <p class="mt-1 text-sm text-neutral-400 font-light">{{ __('app.whatsapp_cta_subtitle') }}</p>
            </div>
