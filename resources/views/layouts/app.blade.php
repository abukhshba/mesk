...
<body class="bg-white text-neutral-900 antialiased">
    ...
    <a href="https://wa.me/{{ $settings->whatsapp }}"
       target="_blank"
       class="fixed bottom-6 {{ app()->getLocale() === 'ar' ? 'left-6' : 'right-6' }} z-50 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300">
