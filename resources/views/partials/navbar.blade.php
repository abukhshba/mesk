            ...
            <div class="flex items-center justify-between h-16 sm:h-20 transition-all duration-300" id="nav-container">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-2.5 group">
                    @if(!empty($settings->logo))
                        <img src="{{ asset('storage/' . $settings->logo) }}" alt="{{ $settings->company_name }}" class="h-10 sm:h-12 w-auto transition-transform group-hover:scale-105">
                    @else
...
<!-- Spacer -->
<div class="h-[100px] sm:h-[116px]"></div>
